...
**Biology** \hfill alignment, annotation, homology modeling, molecular diagnostics, pathway analysis, PCR, phylogenetics \break
...
Participated as part of team "Ghost in the Shell Script" in the 24-hr hackathon to improve the search algorithm of the RASMAS medical recall system. The solution was written in Java and employed an n-gram indexing strategy for calculating Jaccard similarity. \hfill

## Projects \dotfill

**Homebrewing** \hfill \break
_Makgeolli_ \hfill Jan 2023 - Present \break
Brew traditional Korean rice wine. Developed an Arduino fermentation monitoring system that uses an optoisolator and digital scale to track airlock bubble evolution and mass change over time and write logs to an SD card. Received funds from the Noblis Sponsored Research program to sequence samples and develop LAMP assays for microbes critical to the multiple parallel fermentation process. Results were presented at ASM 2024 in Atlanta, GA. \hfill
